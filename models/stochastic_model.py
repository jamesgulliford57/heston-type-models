...
class StochasticModel:
    ...
    def simulate_model(self, init_value, T, n, N, output_directory, scheme='euler'):
        ...
        all_V = np.zeros((N, n)) # and need to generalise
        h = T / n
        t = np.linspace(0, T, n)
        # Select numerical scheme (create list of schemes in another file and use for selction)
        ...
        # Write output files
        write_npy(output_directory, t=t, S=all_S, V=all_V) # Samples 
